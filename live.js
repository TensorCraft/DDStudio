...
class Live extends EventEmitter {
    ...
    async loadedRoomInitAPI() {
        ...
        await this.requestDanmuServerApi();
        await this.initRoomPlayInfo();
        ...
        const _url =
            ...
            '//' +
            (this.config.server || 'broadcastlv.chat.bilibili.com') +
            ':' +
            (this.config.protocol.port || 2243) +
            '/sub';
        ...
        var n = {
            ...
            urlList: [
                ...
                'wss://tx-gz-live-comet-01.chat.bilibili.com:443/sub',
        ...
        var __s = function s(e, t) {
            ...
            function a(e) {
                var t;
                return e && e.state ? (((t = e.state).wsize = 0), (t.whave = 0), (t.wnext = 0), o(e)) : -2;
            }
            var n, i;
            return e && e.state
                ? ((i = e.state),
                    ...
                    t && (t < 8 || 15 < t)
                        ? -2
                        : (null !== i.window && i.wbits !== t && (i.window = null), (i.wrap = n), (i.wbits = t), a(e)))
                : -2;
        };
        var __inflateInit2 = function l(e, t) {
            var n, i;
            return e ? ((i = new __r()), ((e.state = i).window = null), (n = __s(e, t)) !== 0 && (e.state = null), n) : -2;
        };
        var __inflateGetHeader = function (e, t) {
            var n;
            return e && e.state ? (0 == (2 & (n = e.state).wrap) ? E : (((n.head = t).done = !1), 0)) : -2;
        };
        ...
        var __string2buf = function (e) {
            ...
            for (t = new Uint8Array(l), o = a = 0; a < l; o++) {
                55296 == (64512 & (n = e.charCodeAt(o))) &&
                    o + 1 < s &&
                    56320 == (64512 & (i = e.charCodeAt(o + 1))) &&
                    ((n = 65536 + ((n - 55296) << 10) + (i - 56320)), o++),
                    (t[a++] =
                        n < 128
                            ...
                            : ((t[a++] =
                                n < 2048
                                    ? 192 | (n >>> 6)
                                    : ((t[a++] = n < 65536 ? 224 | (n >>> 12) : ((t[a++] = 240 | (n >>> 18)), 128 | ((n >>> 12) & 63))),
                                        128 | ((n >>> 6) & 63))),
                                128 | (63 & n)));
            }
            return t;
            ...
            if (
                ((this.header = new __d()),
                    ...
                    ('string' == typeof t.dictionary
                        ? (t.dictionary = __string2buf(t.dictionary))
                        : '[object ArrayBuffer]' === h.call(t.dictionary) && (t.dictionary = new Uint8Array(t.dictionary)),
        ...
        var __y = function (e, t) {
            ...
            (n = e.state),
                ...
                (m = (1 << n.distbits) - 1);
            e: do {
                p < 15 && ((f += C[i++] << p), (p += 8), (f += C[i++] << p), (p += 8)), (_ = v[f & g]);
                t: for (; ;) {
                    if (((f >>>= b = _ >>> 24), (p -= b), 0 == (b = (_ >>> 16) & 255))) {
                        A[o++] = 65535 & _;
                    } else {
                        if (!(16 & b)) {
                            if (0 == (64 & b)) {
                        ...
                        (E = 65535 & _),
                            (b &= 15) && (p < b && ((f += C[i++] << p), (p += 8)), (E += f & ((1 << b) - 1)), (f >>>= b), (p -= b)),
                        ...
                        n: for (; ;) {
                            ...
                            if (
                                ((S = 65535 & _),
                                    p < (b &= 15) && ((f += C[i++] << p), (p += 8) < b && ((f += C[i++] << p), (p += 8))),
                                    l < (S += f & ((1 << b) - 1)))
                            ) {
                            ...
                            if (((f >>>= b), (p -= b), (b = o - a) < S)) {
                                ...
                                for (; 2 < E;) {
                                    (A[o++] = w[T++]), (A[o++] = w[T++]), (A[o++] = w[T++]), (E -= 3);
                                }
                                E && ((A[o++] = w[T++]), 1 < E && (A[o++] = w[T++]));
                            } else {
                                for (T = o - S; (A[o++] = A[T++]), (A[o++] = A[T++]), (A[o++] = A[T++]), 2 < (E -= 3);) { }
                                E && ((A[o++] = A[T++]), 1 < E && (A[o++] = A[T++]));
                            }
                            break;
                        }
                    }
        ...
        var a = (function () {
            ...
            (n.setTyped = function (e) {
                e
                    ? ((n.Buf8 = Uint8Array), (n.Buf16 = Uint16Array), (n.Buf32 = Int32Array), n.assign(n, r))
        ...
        __i.prototype.push = function (e, t) {
            ...
            var inflate = function (e, t) {
                var g = function (e, t, n, l, c, u, d, h) {
                    ...
                    for (; ;) {
                        for (
                            _ = T - L,
                            E = d[w] < m ? ((b = 0), d[w]) : d[w] > m ? ((b = U[B + d[w]]), M[D + d[w]]) : ((b = 96), 0),
                            f = 1 << (T - L),
                            C = p = 1 << x;
                            (c[g + (P >> L) + (p -= f)] = (_ << 24) | (b << 16) | E | 0), 0 !== p;
                ...
                function u(e, t, n, i) {
                    ...
                    return (
                        null === o.window &&
                        ((o.wsize = 1 << o.wbits), (o.wnext = 0), (o.whave = 0), (o.window = new Uint8Array(o.wsize))),
                        i >= o.wsize
                            ? (f.arraySet(o.window, t, n - o.wsize, o.wsize, 0), (o.wnext = 0), (o.whave = o.wsize))
                            : (i < (r = o.wsize - o.wnext) && (r = i),
                                f.arraySet(o.window, t, n - i, r, o.wnext),
                                (i -= r)
                                    ? (f.arraySet(o.window, t, n - i, i, 0), (o.wnext = i), (o.whave = o.wsize))
                ...
                function c(e) {
                    if (C) {
                        var t;
                        for (d = new Int32Array(512), h = new Int32Array(32), t = 0; t < 144;) {
                            e.lens[t++] = 8;
                        }
                        for (; t < 256;) {
                            e.lens[t++] = 9;
                    ...
                    (e.lencode = d), (e.lenbits = 9), (e.distcode = h), (e.distbits = 5);
                }
                function i(e) {
                ...
                e: for (; ;) {
                    switch (n.mode) {
                        case S:
                            ...
                            (n.dmax = 1 << O), (e.adler = n.check = 1), (n.mode = 512 & h ? 10 : 12), (T = h = 0);
                            break;
                        case 2:
                            for (; T < 16;) {
                                if (0 === l) {
                            ...
                            n.head && (n.head.text = (h >> 8) & 1),
                                512 & n.flags && ((z[0] = 255 & h), (z[1] = (h >>> 8) & 255), (n.check = v(n.check, z, 2, 0))),
                                (T = h = 0),
                                (n.mode = 3);
                        case 3:
                            for (; T < 32;) {
                        ...
                        case 7:
                            if (2048 & n.flags) {
                                ...
                                if ((512 & n.flags && (n.check = v(n.check, r, A, a)), (l -= A), (a += A), O)) {
                                    break e;
                                }
                            } else {
                        ...
                        case 10:
                            ...
                            (e.adler = n.check = i(h)), (T = h = 0), (n.mode = 11);
                        case 11:
                            if (0 === n.havedict) {
                                return (
                                    (e.next_out = s), (e.avail_out = d), (e.next_in = a), (e.avail_in = l), (n.hold = h), (n.bits = T), 2
                                );
                            }
                        ...
                        case 14:
                            ...
                            if (((n.length = 65535 & h), (T = h = 0), (n.mode = 15), 6 === t)) {
                                break e;
                            }
                        ...
                        case 16:
                            if ((A = n.length)) {
                                if ((l < A && (A = l), d < A && (A = d), 0 === A)) {
                                    break e;
                                }

                                f.arraySet(o, r, a, A, s), (l -= A), (a += A), (d -= A), (s += A), (n.length -= A);
                                break;
                            }
                        ...
                        case 19:
                            for (; n.have < n.nlen + n.ndist;) {
                                for (
                                    ;
                                    (R = ((F = n.lencode[h & ((1 << n.lenbits) - 1)]) >>> 16) & 255),
                                    (I = 65535 & F),
                                    !((L = F >>> 24) <= T);
                                ...
                                if (I < 16) {
                                    ...
                                    if (16 === I) {
                                        ...
                                        (O = n.lens[n.have - 1]), (A = 3 + (3 & h)), (h >>>= 2), (T -= 2);
                                    } else if (17 === I) {
                                        for (B = L + 3; T < B;) {
                                            if (0 === l) {
                                                break e;
                        ...
                        case 21:
                            ...
                            if (R && 0 == (240 & R)) {
                                for (
                                    P = L, M = R, D = I;
                                    (R = ((F = n.lencode[D + ((h & ((1 << (P + M)) - 1)) >> P)]) >>> 16) & 255),
                                    (I = 65535 & F),
                                    !(P + (L = F >>> 24) <= T);
                            ...
                            if (((h >>>= L), (T -= L), (n.back += L), (n.length = I), 0 === R)) {
                                n.mode = 26;
                                break;
                            }
                        ...
                        case 22:
                            if (n.extra) {
                                ...
                                (n.length += h & ((1 << n.extra) - 1)), (h >>>= n.extra), (T -= n.extra), (n.back += n.extra);
                            }
                        ...
                        case 23:
                            for (
                                ;
                                (R = ((F = n.distcode[h & ((1 << n.distbits) - 1)]) >>> 16) & 255),
                                (I = 65535 & F),
                                !((L = F >>> 24) <= T);
                            ...
                            if (0 == (240 & R)) {
                                for (
                                    P = L, M = R, D = I;
                                    (R = ((F = n.distcode[D + ((h & ((1 << (P + M)) - 1)) >> P)]) >>> 16) & 255),
                                    (I = 65535 & F),
                                    !(P + (L = F >>> 24) <= T);
                        ...
                        case 24:
                            if (n.extra) {
                                ...
                                (n.offset += h & ((1 << n.extra) - 1)), (h >>>= n.extra), (T -= n.extra), (n.back += n.extra);
                            }
                        ...
                        case 25:
                            ...
                            if (((A = C - d), n.offset > A)) {
                                ...
                                (k = A > n.wnext ? ((A -= n.wnext), n.wsize - A) : n.wnext - A),
                                    A > n.length && (A = n.length),
                                    (x = n.window);
                            } else {
                                (x = o), (k = s - n.offset), (A = n.length);
                            }
                            for (d < A && (A = d), d -= A, n.length -= A; (o[s++] = x[k++]), --A;) { }
                ...
                return (
                    ...
                    (n.hold = h),
                    (n.bits = T),
                    (n.wsize || (C !== e.avail_out && n.mode < 30 && (n.mode < 27 || 4 !== t))) &&
                        u(e, e.output, e.next_out, C - e.avail_out)
                        ? ((n.mode = 31), -4)
                        : ((w -= e.avail_in),
                            (C -= e.avail_out),
                            (e.total_in += w),
                            ...
                            n.wrap &&
                            C &&
                            (e.adler = n.check = n.flags ? v(n.check, o, C, e.next_out - C) : p(n.check, o, C, e.next_out - C)),
                            (e.data_type =
            ...
            do {
                if (
                    (0 === d.avail_out && ((d.output = new Uint8Array(f)), (d.next_out = 0), (d.avail_out = f)),
                        (n = inflate(d, l.Z_NO_FLUSH)) === l.Z_NEED_DICT && p && (n = inflateSetDictionary(this.strm, p)),
                        n === l.Z_BUF_ERROR && !0 === v && ((n = l.Z_OK), (v = !1)),
                ...
                d.next_out &&
                    ((0 !== d.avail_out &&
                        n !== l.Z_STREAM_END &&
                        (0 !== d.avail_in || (i !== l.Z_FINISH && i !== l.Z_SYNC_FLUSH))) ||
                        ('string' === this.options.to
                            ? ((r = s.utf8border(d.output, d.next_out)),
                                (c = d.next_out - r),
            ...
            return (
                n === l.Z_STREAM_END && (i = l.Z_FINISH),
                i === l.Z_FINISH
                    ? ((n = inflateEnd(this.strm)), this.onEnd(n), (this.ended = !0), n === l.Z_OK)
                    : i !== l.Z_SYNC_FLUSH || (this.onEnd(l.Z_OK), !(d.avail_out = 0))
            );
        };
        ...
        var convertToArrayBuffer = (e, t) => {
            ...
            var n = new ArrayBuffer(WS_PACKAGE_HEADER_TOTAL_LENGTH),
                ...
                a = encoder.encode(e);
            return (
                r.setInt32(WS_PACKAGE_OFFSET, WS_PACKAGE_HEADER_TOTAL_LENGTH + a.byteLength),
        ...
        this._ws.on('open', () => {
            ...
            for (var o = 0; o < n.customAuthParam.length; o++) {
                ...
                var s = a.type || 'string';
                switch (
                (void 0 !== r[a.key] && console.error('Token has the same key already! 【' + a.key + '】'),
                    (a.key.toString() && a.value.toString()) ||
                    console.error('Invalid customAuthParam, missing key or value! 【' + a.key + '】-【' + a.value + '】'),
                    s)
                ) {
                    case 'string':
                        r[a.key] = a.value;
                ...
                if (n instanceof Array) {
                    ...
                    switch (n.op) {
                        case WS_OP_HEARTBEAT_REPLY:
                            this.emit('WS_OP_HEARTBEAT_REPLY', n.body);
                            break;
                        case WS_OP_MESSAGE:
                        ...
                        case WS_OP_CONNECT_SUCCESS:
                            if (0 !== n.body.length && n.body[0]) {
                                switch (n.body[0].code) {
                                    case WS_AUTH_OK:
                                        this.emit('WS_AUTH_OK', n.body);
                                        heartBeat();
                                        break;
                                    case WS_AUTH_TOKEN_ERROR: {
                                        this.emit('WS_AUTH_TOKEN_ERROR', n.body);
                                        break;
                                    }
                                    default:
                                        this.emit('WS_ON_CLOSE', n.body);
                                }
                            } else {
                                heartBeat();
                            }
    ...
    getStream() {
        ...
        for (const iterator of stream) {
            _map[iterator.protocol_name] = iterator.format
                .map((format_data) => {
                    return format_data.codec
                        .map((codec_data) => {
    ...
    initRoomPlayInfo() {
        return instance
            ...
            .then((x) => {
                if (x.data.code !== 0) {
                    throw new Error(x.data.message);
                }

                this.config.cid = x.data.data.room_id;
                this.config.rid = x.data.data.room_id;
                this.config.uid = x.data.data.uid;
                this.config.room_play_info = x.data.data;
    ...
    requestDanmuServerApi() {
        return instance
            .get('https://api.live.bilibili.com/xlive/web-room/v1/index/getDanmuInfo', {
                params: { type: 0, id: this.config.cid },
            })
            .then((x) => this.setServerHost(x.data.data));
    }
    setServerHost(e) {
        if (
            ((this.state.hostServer.port = e.port),
    ...
    onReceivedMessage(body, seq) {
        ...
        var _checkCmdPermission = function (e) {
            ...
            var i = e.split(':'),
                r = i[0];
            if (1 !== i.length)
                switch (((n = !0), parseInt(i[4], 10))) {
                    case 0:
                        (t.danmaku = !1), (t.callback = !1);
                        break;
                    case 1:
                        (t.danmaku = !1), (t.callback = !0);
                        break;
                    case 2:
                        (t.danmaku = !0), (t.callback = !1);
                        break;
                    case 3:
                        (t.danmaku = !0), (t.callback = !0);
                }
            return {
                type: r,
                shouldIgnore: t,
        ...
        if (body && body instanceof Object) {
            ...
            switch ((p.hasCheckNum && (body.cmd = v), body.cmd)) {
                ...
                case STATE_STRING.WS_MESSAGE_DANMAKU: {
                    ...
                    this.emit('WS_MESSAGE_DANMAKU', _);
                    break;
                }
                /** 礼物 */
                case STATE_STRING.WS_MESSAGE_SEND_GIFT: {
                    this.emit('WS_MESSAGE_SEND_GIFT', body.data);
                    break;
                }
                /** 热点房间 */
                case STATE_STRING.HOT_ROOM_NOTIFY: {
                    this.emit('WS_HOT_ROOM_NOTIFY', body.data);
                    break;
                }
                /** 直播间PK */
                ...
                case STATE_STRING.WS_PK_MIC_END: {
                    // PK麦克风关闭
                    this.emit('WS_PK_EVENT', body.data);
                    break;
                }
                /** 直播事件 */
                ...
                case STATE_STRING.PLAY_PROGRESS_BAR: {
                    // 播放进度条事件
                    this.emit('WS_LIVE_EVENT', body.data);
                    break;
                }
            }
        }
